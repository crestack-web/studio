// Send welcome email with logo and proper theme
...
async function sendWelcomeEmail() {
  ...
  const logoUrl = 'https://busmo.web.app/email-logo.png';
  ...
  const emailData = {
    ...
    htmlContent: `
      ...
      <body>
        <div class="container">
          <div class="header">
            <img src="${logoUrl}" alt="Busmo Logo" class="logo">
  ...
  try {
    console.log('Sending welcome email with logo and proper theme...');
