...
export default function SubscribePage() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        alert(`Subscription successful! You've selected the ${selectedPlan} plan at $${PLANS.find(p => p.id === selectedPlan)?.price}/month.\n\nIn production, this would redirect to Paystack for payment.`);
        
        // Update to active after "payment"
