    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#F4F4F8] to-[#E8E8F0] px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <polygon points="36,58 44,58 42,66 38,66" fill="#1DB954"></polygon>
          ...
          <h2 className="text-2xl font-bold font-headline text-[#0A0A0F] mb-1">Business Owner</h2>
          <p className="text-sm text-[#555568] mb-6 text-center">
            Manage your business, track performance, and sell online.
          </p>
          <div className="flex gap-4 w-full">
            <Link
              href="/login/form"
              className="flex-1 bg-[#6B3FE7] text-white font-semibold rounded-xl h-12 flex items-center justify-center text-base transition hover:bg-[#4B27B0]"
            >
              Log In
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold font-headline text-[#0A0A0F] mb-1">Staff Member</h2>
          <p className="text-sm text-[#555568] mb-6 text-center">
            Log in to record sales and manage inventory for your employer.
          </p>
          <Link
            href="/login/staff"
            className="w-full bg-[#16A34A] text-white font-semibold rounded-xl h-12 flex items-center justify-center text-base transition hover:bg-[#12803A]"
          >
            Staff Log In
          </Link>
