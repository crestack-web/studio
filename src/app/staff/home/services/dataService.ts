...
export async function fetchProducts(
  ...
  try {
    // Use 'merchants' collection to match existing Firestore structure
    const productsQuery = query(
      collection(db, 'merchants', businessId, 'products'),
      where('active', '==', true)
    );
...
export async function recordSale(
  ...
  try {
    ...
    const saleRef = await addDoc(collection(db, 'merchants', businessId, 'sales'), {
...
export async function fetchRecentSales(
  ...
  try {
    // Use 'merchants' collection
    const salesQuery = query(
      collection(db, 'merchants', businessId, 'sales'),
