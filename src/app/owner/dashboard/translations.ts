...
const en: TranslationDict = {
  ...
  'nav.services':'Services','nav.staff':'Staff','nav.suppliers':'Suppliers','nav.customers':'Customers','nav.invoiceVerification':'Invoice Verification','nav.branches':'Branches','nav.settings':'Settings',
  'nav.menuManagement':'Menu Management','nav.ingredients':'Ingredients','nav.expiryAlerts':'Expiry Alerts',
  'nav.production':'Production','nav.ecommerce':'E-commerce','nav.payroll':'Payroll',
...
const fr: TranslationDict = {
  ...
  'nav.services':'Services','nav.staff':'Personnel','nav.suppliers':'Fournisseurs','nav.customers':'Clients','nav.invoiceVerification':'Vérification Facture','nav.branches':'Succursales','nav.settings':'Paramètres',
  'nav.menuManagement':'Gestion Menu','nav.ingredients':'Ingrédients','nav.expiryAlerts':'Alertes Expiration',
  'nav.production':'Production','nav.ecommerce':'E-commerce','nav.payroll':'Paie',
...
const ha: TranslationDict = {
  ...
  'nav.services':'Ayyuka','nav.staff':"Ma'aikata",'nav.suppliers':'Masu Samfura','nav.invoiceVerification':'Bincike Bayanin Fatura','nav.settings':'Saiti',
...
const sw: TranslationDict = {
  ...
  'nav.services':'Huduma','nav.staff':'Wafanyakazi','nav.suppliers':'Wauzaji','nav.customers':'Wateja','nav.invoiceVerification':'Uthibitishaji Ankara','nav.settings':'Mipangilio',
  'nav.menuManagement':'Usimamizi wa Menyu','nav.ingredients':'Viungo','nav.expiryAlerts':'Matangazo ya Muda',
  'nav.production':'Uzalishaji','nav.ecommerce':'Biashara ya Mtandaoni','nav.payroll':'Mshahara',
...
const yo: TranslationDict = {
  ...
  'nav.services':'Iṣẹ','nav.staff':'Awọn Oṣiṣẹ','nav.suppliers':'Àwọn oníṣòwò','nav.customers':'Àwọn oníṣàjẹ','nav.invoiceVerification':'Ìṣàkóso Fìwéránṣẹ','nav.settings':'Ètò',
  'nav.menuManagement':'Ìṣàkóso Àkànyẹ̀','nav.ingredients':'Àwọn Eroja','nav.expiryAlerts':'Ìbànújẹ́ Akókò',
  'nav.production':'Ṣiṣe','nav.ecommerce':'Ètò Ìṣòwò Lórí Ayélujára','nav.payroll':'Isánwó',
...
const ig: TranslationDict = {
  ...
  'nav.services':'Ọrụ','nav.staff':'Ndị ọrụ','nav.suppliers':'Ndị Na-ere','nav.customers':'Ndị Ahịa','nav.invoiceVerification':'Nchekwa Fworo','nav.settings':'Ntọala',
  'nav.menuManagement':'Nchịkwa Menu','nav.ingredients':'Ngwaahịa','nav.expiryAlerts':'Ntịrị Mbụ',
  'nav.production':'Mmepụta','nav.ecommerce':'Ahịa Intanet','nav.payroll':'Ụgwọ Ọrụ',
...
const am: TranslationDict = {
  ...
  'nav.services':'አገልግሎቶች','nav.staff':'ሠራተኞች','nav.suppliers':'አቅራቢዎች','nav.customers':'ደንበኞች','nav.invoiceVerification':'የእሴት ማረጋገጥ','nav.settings':'ቅንጅቶች',
  'nav.menuManagement':'የምግብር አስተዳደር','nav.ingredients':'ንጥረኞች','nav.expiryAlerts':'የማሽቻ ማስጠንቀቂያ',
  'nav.production':'ምርት','nav.ecommerce':'የኢንተርኔት ንግድ','nav.payroll':'የደመዝኖን ክፍዎ',
...
const ar: TranslationDict = {
  ...
  'nav.services':'الخدمات','nav.staff':'الموظفون','nav.suppliers':'الموردين','nav.customers':'العملاء','nav.invoiceVerification':'التحقق من الفاتورة','nav.settings':'الإعدادات',
  'nav.menuManagement':'إدارة القائمة','nav.ingredients':'المكونات','nav.expiryAlerts':'تنبيهات انتهاء الصلاحية',
  'nav.production':'الإنتاج','nav.ecommerce':'التجارة الإلكترونية','nav.payroll':'كشوف المرتبات',
...
const zu: TranslationDict = {
  ...
  'nav.services':'Izinsizakalo','nav.staff':'Abasebenzi','nav.suppliers':'Abathengisi','nav.customers':'Abakhethi','nav.invoiceVerification':'Ukuqinisekisa Kwazipho','nav.settings':'Izilungiselelo',
  'nav.menuManagement':'Ukuphathwa Kwemenyu','nav.ingredients':'Izingosi','nav.expiryAlerts':'Izixwayiso Zomhla Siphelile',
  'nav.production':'Ukukhiqiza','nav.ecommerce':'Ukuthengisa Ku-inthanethi','nav.payroll':'Iholo',
...
const af: TranslationDict = {
  ...
  'nav.services':'Dienste','nav.staff':'Personeel','nav.suppliers':'Verskaffers','nav.customers':'Klanten','nav.invoiceVerification':'Faktuur Verifikasie','nav.settings':'Instellings',
  'nav.menuManagement':'Menu Bestuur','nav.ingredients':'Bestanddele','nav.expiryAlerts':'Vervaldatum Waarskuwings',
  'nav.production':'Produksie','nav.ecommerce':'E-handel','nav.payroll':'Loonstaat',
