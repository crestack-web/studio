...
const en: TranslationDict = {
  ...
  'common.units':'units','common.restock':'Restock','common.prev':'Previous',
  'common.next':'Next','common.daysAgo':'days ago','common.free':'free','common.open':'Open',
  ...
  'settings.currencyThousands':'Thousands',
  'settings.currencyDecimal':'Decimal',
  'settings.currencyPlaces':'Places',
  'settings.currencySymbol':'Symbol',
  'settings.currencyBefore':'before','settings.currencyAfter':'after',
...
const am: TranslationDict = {
  ...
  'nav.addExpense':'ወጪ ጨምር','nav.cashflow':'የገንዘብ ��ሰት','nav.statement':'የፋይናንስ መግለጫ',
