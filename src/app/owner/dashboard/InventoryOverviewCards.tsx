  ...
  const cards: StatCard[] = [
    {
      ...
      label: t('dashboard.invOverview.totalProducts'),
      value: `${stats.total}`,
      sub: t('dashboard.invOverview.totalProductsSub'),
      accent: 'var(--purple)',
    ...
    },
    {
      ...
      label: t('dashboard.invOverview.unitsInStock'),
      value: stats.totalUnits.toLocaleString(),
      sub: t('dashboard.invOverview.unitsInStockSub'),
      accent: 'var(--blue)',
    ...
    },
    {
      ...
      label: t('dashboard.invOverview.lowStock'),
      value: `${stats.lowStock}`,
      sub: `${stats.outOfStock} ${t('dashboard.invOverview.outOfStock')}`,
      accent: 'var(--amber)',
    ...
    },
    {
      ...
      label: t('dashboard.invOverview.outOfStock'),
      value: `${stats.outOfStock}`,
      sub: t('dashboard.invOverview.outOfStockSub'),
      accent: 'var(--red)',
      accentBg: 'var(--red-bg)',
    ...
    },
    {
      ...
      label: t('dashboard.invOverview.inventoryValue'),
      value: formatMoney(stats.invValue),
      sub: t('dashboard.invOverview.inventoryValueSub'),
      accent: 'var(--teal)',
    ...
    },
    {
      ...
      label: t('dashboard.invOverview.potentialRevenue'),
      value: formatMoney(stats.potRevenue),
      sub: `${formatMoney(potentialProfit)} ${t('dashboard.invOverview.potentialProfit')}`,
      accent: 'var(--green)',
