...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: 'margin-calculator', label: 'Margin Calculator', tip: 'Healthy pricing & margins', iconClass: 'margin-calculator' },
      { id: 'can-i-buy', label: 'Can I Buy This?', tip: 'Owner cash check before purchase', iconClass: 'can-i-buy' },
      { id: 'jobs', label: 'Jobs & Projects', tip: 'Track jobs, costs, payments & materials', iconClass: 'ni-jobs' },
      { id: 'recycling', label: 'Material Collection', tip: 'Weigh-in purchases from suppliers', iconClass: 'ni-recycle' },
