...
export function Topbar() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const now = new Date();
      const end =
        trialInfo.isGrace && trialInfo.graceEndDate
          ? trialInfo.graceEndDate
      ...
      setTimeLeft({
        ...
        isExpired: false,
        isGrace: trialInfo.isGrace,
        trialEndDate: trialInfo.trialEndDate,
        graceEndDate: trialInfo.graceEndDate,
      });
    };
  ...
  const isGrace = !!timeLeft?.isGrace;
  const chipPrefix = isGrace ? 'Extension' : 'Trial';
  const chipTitle = isGrace
    ? `Free extension ends in ${fullLabel} — subscribe to keep access`
    : `Trial ends in ${fullLabel}`;
      ...
      <div className={styles.actions}>
        {timeLeft && (
          ...
          >
            ...
            <span className={styles.trialFull}>
              {chipPrefix} · {fullLabel}
            </span>
          </div>
        )}
