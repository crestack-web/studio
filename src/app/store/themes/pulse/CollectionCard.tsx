...
export function PulseCollectionCard({ collection, storeSlug }: ThemeCollectionCardProps) {
  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: hovered
          ? '0 14px 44px rgba(255,107,53,0.2), 0 0 0 1px rgba(255,107,53,0.25)'
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: hovered
              ? 'linear-gradient(135deg, rgba(255,107,53,0.3), rgba(247,201,72,0.25))'
        ...
        <div style={{ padding: '8px 16px 16px' }}>
          {collection.description && (
            <p style={{
              fontSize: '0.82rem', color: '#8B7355', margin: 0,
