...
const SupportSection: React.FC<SupportSectionProps> = ({ onNavigate }) => {
  ...
  const [chatMessages, setChatMessages] = useState<Array<{ role: 'user' | 'support'; message: string }>>([
    { role: 'support', message: 'Hi! 👋 Welcome to Busmo Support. How can we help you today?' }
  ]);
