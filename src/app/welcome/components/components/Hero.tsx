...
import { Page } from '../../../../../../../Users/sd/Downloads/busmo-landing-tsx/busmo-landing/src/types';
    ...
    <div className="hero-inner">
      ...
      <div className="dashboard-preview" style={{ marginTop: 56 }}>
        ...
        <div className="dash-card ask-busmo-card">
          <div className="dash-card-icon" style={{ background: 'rgba(255,255,255,0.2)' }}>🤖</div>
          <div className="dash-card-label">Ask Busmo AI</div>
