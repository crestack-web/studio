...
export const CATEGORY_FEATURES: Record<string, string[]> = {
  ...
  grocery: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Expiry Alerts", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Payroll Management"],
  fashion: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "E-commerce Storefront", "Payroll Management"],
  electronics: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "E-commerce Storefront", "Payroll Management"],
  manufacturing: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Production Tracking", "Expense Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Multi-branch Support", "Payroll Management"],
  services: ["Sales Recording", "Staff Management", "Cash Flow Analysis", "Expense Management", "Customer Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Payroll Management"],
  pharmacy: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Expiry Alerts", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Payroll Management"],
  supermarket: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Expiry Alerts", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Multi-branch Support", "Payroll Management"],
  cafe: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Menu Management", "Ingredient Tracking", "Expiry Alerts", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Payroll Management"],
  wholesale: ["Sales Recording", "Inventory Tracking", "Staff Management", "Cash Flow Analysis", "Credit Tracking", "Expense Management", "Customer Management", "Supplier Management", "Profit/Loss Reports", "Business Analytics", "Ask MO AI Assistant", "Multi-branch Support", "Payroll Management"],
