...
export default function AdminPage() {
  ...
  useEffect(() => {
    const unsubscribe = subscribeToSupportStats((stats: { openConversations: number; pendingMessages: number; averageResponseTime: number }) => {
  ...
  useEffect(() => {
    const unsubscribe = subscribeToDailyActiveUsers((count: number) => {
      setDailyUsers(count);
    });
  ...
  useEffect(() => {
    const unsubscribe = subscribeToMonthlyActiveUsers((count: number) => {
