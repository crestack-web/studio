  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome! You can now shop on the marketplace.",
      });
      router.push('/market');
    ...
    <OnboardingLayout>
      <Card className="w-full">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-headline">Create a Buyer Account</CardTitle>
          <CardDescription>Start shopping from the best local businesses.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Button className="w-full h-14 text-lg" onClick={handleSignUp} disabled={isLoading || !name || !email || !password}>
           ...
           <p className="text-sm text-center text-muted-foreground pt-2">
              ...
              <Link href="/market/login" className="underline font-medium text-primary">
                  Log In
              </Link>
          </p>
        </CardContent>
