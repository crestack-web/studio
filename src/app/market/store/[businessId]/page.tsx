...
// Same interfaces from [slug]/page
...
export default function StoreIdPage() {
    ...
    const { data: businessProfile, isLoading } = useDoc<BusinessProfile>(businessProfileRef);
    ...
    // After loading, if no business is found, show a 404-like page.
    if (!businessProfile) {
        notFound();
    }
