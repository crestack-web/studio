...
// Based on test-email.js pattern
      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p class="welcome-text">Hi ${TEST_NAME},</p>
              <p class="welcome-text">Welcome to Busmo! We're excited to help you grow ${TEST_BUSINESS}.</p>
...
async function sendEmail(emailNumber) {
...
async function testWelcomeSeries() {
  ...
  try {
    ...
    console.log('='.repeat(60));
    console.log('\n🎉 All 5 welcome emails sent successfully!');
